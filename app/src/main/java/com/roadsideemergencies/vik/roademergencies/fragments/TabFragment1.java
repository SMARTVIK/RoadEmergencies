...
public class TabFragment1 extends Fragment {
    ...
    private void getPlacesNearYou() {
        ...
        Utility.getPlacesNearYou("Hospitals", "Hospitals", "1000", String.valueOf(latitude==0?"28.499264":latitude), String.valueOf(longitude==0?"77.176466":longitude), new JsonHttpResponseHandler() {
